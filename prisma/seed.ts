...
async function main() {
  ...
  const roughA1 = await prisma.roughStone.create({
    data: {
      ...
      purchasePrice: 8900, currency: "USD", pricePerCt: 350.39,
  ...
  const roughA2 = await prisma.roughStone.create({
    data: {
      ...
      purchasePrice: 5100, currency: "USD", pricePerCt: 272.73,
      status: "IN_CUTTING",
    },
  });
  ...
  const roughA3 = await prisma.roughStone.create({
    data: {
      ...
      purchasePrice: 2400, currency: "USD", pricePerCt: 196.72,
      status: "AVAILABLE",
    },
  });
  ...
  const roughB1 = await prisma.roughStone.create({
    data: {
      ...
      purchasePrice: 12500, currency: "USD", pricePerCt: 1275.51,
  ...
  const roughB2 = await prisma.roughStone.create({
    data: {
      ...
      purchasePrice: 15400, currency: "USD", pricePerCt: 2406.25,
      status: "INSPECTED",
    },
  });
  ...
  const cuttingJob = await prisma.cuttingJob.create({
    data: {
      ...
      actualYieldPct: 46.9,
      cuttingCost: 900, laborCost: 500, machineCost: 250, currency: "USD",
  ...
  const gemA = await prisma.gemstone.create({
    data: {
      ...
      totalCost: 0, costPerCt: 0, currency: "USD",
  ...
  await prisma.priceHistory.createMany({
    data: [
      { gemstoneId: gemA.id, oldPrice: null,  newPrice: 16000, currency: "USD", reason: "Initial listing", changedBy: "Sales" },
      { gemstoneId: gemA.id, oldPrice: 16000, newPrice: 17500, currency: "USD", reason: "Market uplift",   changedBy: "Sales" },
      { gemstoneId: gemA.id, oldPrice: 17500, newPrice: 18500, currency: "USD", reason: "Certificate received", changedBy: "Sales" },
    ],
  });
  ...
  await prisma.certificate.create({
    data: {
      ...
      laboratoryFees: 90, currency: "USD",
  ...
  const custA = await prisma.customer.create({
    data: {
      ...
      preferences: JSON.stringify({
        ...
        minWeightCt: 3, maxWeightCt: 10, budgetMin: 10000, budgetMax: 40000, currency: "USD",
      }),
    },
  });
  ...
  const enquiry = await prisma.enquiry.create({
    data: {
      ...
      budgetMin: 18000, budgetMax: 22000, currency: "USD",
      quantity: 1,
  ...
  await prisma.reservation.create({
    data: {
      ...
      price: 18500, deposit: 5550, currency: "USD",
  ...
  await prisma.shipment.create({
    data: {
      ...
      destination: "Paris",
      destCountry: "France",
      shippingCost: 220, insuranceCost: 65, declaredValue: 2600, currency: "USD",
  ...
  async function exp(cat: string, amount: number, description: string, incurredAt: Date, vendor?: string, notes?: string) {
    ...
    await prisma.expense.create({
      data: {
        code, category: cat, amount, currency: "USD",
        vendor: vendor ?? null,
